...
-type command() ::
    ...
    {response, correlation_id(),
     ...
     {resolve_offset_spec, response_code(), offset_type(),
      osiris:offset() | osiris:timestamp()}} |
    {unknown, binary()}.
...
response_body({resolve_offset_spec = Tag, Code, OffsetType, Offset}) ->
    {command_id(Tag), <<Code:16, OffsetType:16, Offset:64>>};
